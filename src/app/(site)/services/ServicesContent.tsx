...
const additionalServices = [
  ...
  },
  {
    ...
    price: "100",
    description: "(Ціна включає вартість мита) Підготовка бланка та сплата державного збору за розгляд справи.",
  },
  {
    title: "Оплата мита Tasa 790 012",
    price: "50",
    description: "(Ціна включає вартість мита) Оформлення та сплата збору за випуск пластикової картки резидента (TIE).",
  },
  {
